      ...
      <div className="container flex items-center justify-between h-16 px-2 sm:px-4 md:px-6">
        <div className="flex items-center gap-4">
          ...
          <nav className="hidden md:flex items-center gap-6 ml-6">
            ...
            <Link to="/global-market-realtime" className="text-slate-700 font-medium hover:text-fin-primary dark:text-slate-300 dark:hover:text-white flex items-center gap-1">
